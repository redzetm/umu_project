...
# UmuOS-0.1.8-dev 基本設計書

## 1. 目的

- UmuOS-0.1.8-dev を「Kernel + initramfs + switch_root + ext4(rootfs)」の最小構成で起動できる。
...
## 3. スコープ（UmuOS-0.1.8-devで成立させる機能）
...
- 詳細な手順（コピペ手順書）: `UmuOS-0.1.8-dev-詳細設計書.md`
